...
<div class="container">
    ...
    <div class="mb-4">
        ...
        <form method="POST" action="{{ route('vendedor.registrarVenta') }}">
            @csrf
            <div id="productos-container" class="form-row">
                ...
                <div class="form-group col-md-2">
                    ...
                    <select class="form-control" id="producto_id_2" name="productos[1][producto_id]">
                        <option value="">Seleccione...</option>
                        @foreach($productos as $producto)
                            <option value="{{ $producto->id }}">{{ $producto->nombres }}</option>
                        @endforeach
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="number" class="form-control" id="cantidad_venta_2" name="productos[1][cantidad_venta]" min="1">
                </div>
            </div>
            <div class="form-group col-md-4">
